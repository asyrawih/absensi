<footer class="footer footer-black  footer-white ">
    ...
    <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div tabindex="0" class="ps-scrollbar-x" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 747px; right: 0px;"><div tabindex="0" class="ps-scrollbar-y" style="top: 0px; height: 424px;"></div></div></div>
  </div>
  <!--   Core JS Files   -->
